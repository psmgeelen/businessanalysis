...
series_df <- data.frame(series_1 = c(series), time = c(time(series)))
...
acf(series_df["series_1"], plot=FALSE, lag.max =10)
acf(series_df["series_1"], plot=TRUE, lag.max=20, xlim=c(0,20), ylab="Auto Correlogram", xlab="Lags in Years")
